...
bad_text = """
왜 이런 일이 일어나고 있는 거야? 일주일 동안 폐기물을 치워주지 않으면 어떤 일이 벌어지는지 알고 있어? 벌레가 집에 들어와서 꼬이고 있는 거야! 이건 어떤 쓰레기 행정인데?

당장 이 문제를 해결해야 해! 너희들은 뭐하는 거야? 이런 불쾌한 상황을 얼마나 더 지켜볼 거야?

지금 바로 해결해야 해! 나의 건강과 안전이 최우선이야! 너희들은 이런 사태를 방치하고 있어도 괜찮은 건가?
"""

chain.invoke({"input": bad_text})
